...
/**
 * An {@code UnsupportedTargetException} is thrown by a {@code RuntimeInstance}
 * implementation whenever it cannot create a {@code ITypeAdapter} capable of 
 * serializing a given source class instance for a particular target class.
 * 
...
public class UnsupportedTargetException extends Exception {
	...
	private static final long serialVersionUID = -307003708604553694L;
