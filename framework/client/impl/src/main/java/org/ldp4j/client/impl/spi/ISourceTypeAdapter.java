...
public interface ISourceTypeAdapter<S> {
	
	boolean supportsTarget(Class<?> target);
	
	<T> ITypeAdapter<S,T> createTypeAdapter(Class<T> targetClass) throws UnsupportedTargetException;
