...
public class SpecificationLDPResourceITest extends AbstractLDPResourceCompatibilityITest {

	@Override
	protected ILDPContainer createContainerClient(URL url) throws Exception {
		return LDPClientFactory.createContainer(url);
	}

	@Override
	protected ILDPResource createResourceClient(URL url) throws Exception {
		return LDPClientFactory.createResource(url);
	}
