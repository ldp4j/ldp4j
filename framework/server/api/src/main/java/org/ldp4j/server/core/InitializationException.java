...
/**
 * A checked exception that will be thrown by initialization methods of <i>Linked 
 * Data Platform Containers</i> when the containers cannot be initialized.
 * 
 ...
 */
public class InitializationException extends LinkedDataPlatformException {
