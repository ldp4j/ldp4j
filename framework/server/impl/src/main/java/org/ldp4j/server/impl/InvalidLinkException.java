...
public class InvalidLinkException extends Exception {
	...
	private static final long serialVersionUID = -211885018947319576L;
	private final String link;

	public InvalidLinkException(String message, Throwable t, String link) {
		super(message,t);
		this.link = link;
	}

	public InvalidLinkException(String message, String link) {
		this(message,(Throwable)null,link);
	}
