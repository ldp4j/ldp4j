...
public final class CapabilitiesAdapter {
	...
	public static org.ldp4j.server.deployment.Capabilities toEndpointCapabilities(Capabilities capabilities) {
	...
	public static Capabilities fromEndpointCapabilities(org.ldp4j.server.deployment.Capabilities capabilities) {
		org.ldp4j.server.deployment.Capabilities tmp=capabilities;
		if(tmp==null) {
