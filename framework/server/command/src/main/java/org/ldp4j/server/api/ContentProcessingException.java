...
public class ContentProcessingException extends RuntimeException {
	...
	private final transient List<Variant> supportedVariants;
	private final transient Resource resource;

	public ContentProcessingException(String message, Resource resource, List<Variant> supportedVariants) {
		super(message);
		this.supportedVariants=new ArrayList<Variant>(supportedVariants);
