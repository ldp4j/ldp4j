...
import org.ldp4j.server.controller.InvalidQueryDiagnosedException;

@Provider
public class InvalidQueryDiagnosedExceptionMapper implements ExceptionMapper<InvalidQueryDiagnosedException> {

	@Override
	public Response toResponse(InvalidQueryDiagnosedException throwable) {
