...
import org.ldp4j.server.controller.UnknownConstraintReportException;

@Provider
public class UnknownConstraintReportExceptionMapper implements ExceptionMapper<UnknownConstraintReportException> {

	@Override
	public Response toResponse(UnknownConstraintReportException throwable) {
