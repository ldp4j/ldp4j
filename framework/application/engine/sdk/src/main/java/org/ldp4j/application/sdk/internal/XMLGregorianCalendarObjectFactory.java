...
public class XMLGregorianCalendarObjectFactory implements ObjectFactory<XMLGregorianCalendar> {

	@Override
	public Class<? extends XMLGregorianCalendar> targetClass() {
		return XMLGregorianCalendar.class;
	}

	@Override
	public XMLGregorianCalendar fromString(String rawValue) {
		try {
			return
				TimeUtils.
					newInstance().
			...
			throw new ObjectParseException(e,XMLGregorianCalendar.class,rawValue);
		}
	}

	@Override
	public String toString(XMLGregorianCalendar value) {
		return
			Literals.
				of(value).
					dateTime().
