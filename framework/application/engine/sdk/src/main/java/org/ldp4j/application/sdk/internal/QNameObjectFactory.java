...
public class QNameObjectFactory implements ObjectFactory<QName> {

	@Override
	public Class<? extends QName> targetClass() {
		return QName.class;
	}

	@Override
	public QName fromString(String rawValue) {
		try {
			return QName.valueOf(rawValue);
		} catch (IllegalArgumentException e) {
			throw new ObjectParseException(e,QName.class,rawValue);
		}
	}
