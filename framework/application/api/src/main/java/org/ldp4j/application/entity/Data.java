...
public final class Data {
	...
	public static DataSource createDataSource(Configuration config) throws ConfigurationException {
		return Data.getService(DataSourceFactory.class,config).createDataSource();
	}
