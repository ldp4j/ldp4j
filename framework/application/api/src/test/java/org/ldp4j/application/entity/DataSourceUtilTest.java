...
public class DataSourceUtilTest {
	...
	public void testFormatDataSource() {
		IdentityFactory idFactory=IdentityFactory.create();
		...
		Entity ent2 = dataSource.newEntity(idFactory.createManagedIdentity(DataSource.class,123));
		...
		System.out.println("After updating: "+DataSourceUtil.formatIdentity(ent3));
