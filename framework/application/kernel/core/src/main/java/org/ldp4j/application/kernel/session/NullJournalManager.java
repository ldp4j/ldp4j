...
final class NullJournalManager implements JournalManager {

	private final Journal journal;
	private final Journaler journaler;

	NullJournalManager(SessionId sessionId) {
		this.journal=new NullJournal(sessionId);
		this.journaler=new NullJournaler();
	}
