...
public class PopulationException extends Exception {
	 ...
	 *
	 */
	private static final long serialVersionUID = -4444313186362785141L;

	public PopulationException() {
		super();
	}

	public PopulationException(String message, Throwable t) {
		super(message, t);
	}
	...
	public PopulationException(Throwable t) {
		super(t);
	}
