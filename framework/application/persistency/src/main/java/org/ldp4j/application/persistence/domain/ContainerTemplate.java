...
public abstract class ContainerTemplate extends RDFSourceTemplate implements Serializable {
	...
	private Template memberTemplate;
	...
	@JoinColumn(name="member_template_id")
	public Template getMemberTemplate() {
		return memberTemplate;
	}

	public void setMemberTemplate(Template memberTemplate) {
	...
	protected void toString(ToStringHelper helper) {
		...
		helper.
			add("memberTemplate",DomainHelper.identifyEntity(this.memberTemplate));
	}
