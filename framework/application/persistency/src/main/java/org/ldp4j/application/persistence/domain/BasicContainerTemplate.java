...
/**
 * Entity implementation class for Entity: BasicContainerTemplate
 *
 */
@Entity
public class BasicContainerTemplate extends ContainerTemplate implements Serializable {

	private static final long serialVersionUID = 1L;

	public BasicContainerTemplate() {
		super();
	}
