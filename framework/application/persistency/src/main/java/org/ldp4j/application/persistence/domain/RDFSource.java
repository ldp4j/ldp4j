...
/**
 * Entity implementation class for Entity: RDFSource
 *
 */
@Entity
public class RDFSource extends Resource implements Serializable {
	...
	public void accept(ResourceVisitor visitor) {
		visitor.visitRDFSource(this);
	}

	@Override
	public void setDefinedBy(Template template) {
		checkArgument(template instanceof RDFSourceTemplate,"Invalid template");
