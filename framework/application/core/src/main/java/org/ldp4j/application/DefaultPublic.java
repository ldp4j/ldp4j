...
import org.ldp4j.application.Public.Status;
...
abstract class DefaultPublic implements Public {
	...
	protected DefaultPublic(ApplicationContext applicationContext, Endpoint endpoint) {
