...
public abstract class PublicContainer<T extends ContainerTemplate> extends PublicRDFSource {
	...
	protected PublicContainer(ApplicationContext applicationContext, Endpoint endpoint, Class<? extends T> templateClass) {
