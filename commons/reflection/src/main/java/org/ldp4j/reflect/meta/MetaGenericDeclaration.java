...
/**
 * An interface for facilitating the introspection of entities that declare type
 * variables .
 *
 * @author Miguel Esteban Guti&eacute;rrez
 *
 * @param <T>
 *            The introspected {@code GenericDeclaration} type.
 * @see java.lang.reflect.GenericDeclaration
 */
public interface MetaGenericDeclaration<D extends GenericDeclaration> extends Meta<D> {

	/**
	 * @see java.lang.reflect.GenericDeclaration#getTypeParameters()
	 */
	List<MetaTypeVariable<D>> getTypeParameters();
